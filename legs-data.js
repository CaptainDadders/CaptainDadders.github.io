...
,
  ...
  },
  {
    lat: 39.6653,
    lng:  -95.0133,
    label: "Leg 19: The First Fourth",
    location: "KMKC → 64MO · Kansas City MO to SW of St. Joseph MO",
    date: "May 26, 2026",
    thumb: "Expedition3/Legs/Leg19-IndependenceCreek.png",
    post: "Expedition3/Legs/leg-19.html",
    slug: "leg-19",
    lcDates: "June 29 – July 4, 1804",
    nm: 60,
    duration: "0:39"
  },
  {
    lat: 40.1428,
    lng: -95.3883,
    label: "Leg 20: A Fevered River, and a Promise in Washington",
    location: "64MO → MO24 · SW of St. Joseph MO to Craig MO",
    date: "May 27, 2026",
    thumb: "Expedition3/Legs/Leg20-WindingRiver.png",
    post: "Expedition3/Legs/leg-20.html",
    slug: "leg-20",
    lcDates: "July 5–13, 1804",
    nm: 69,
    duration: "0:38"
  },
  {
    ...
    date: "May 29, 2026",
    thumb: "Expedition3/Legs/Leg21-RiverCutoffs.png",
    post: "Expedition3/Legs/leg-21.html",
    slug: "leg-21",
    lcDates: "July 14–27, 1804",
    nm: 97,
    duration: "0:57"
  },
  {
    ...
    date: "June 1, 2026",
    thumb: "Expedition3/Legs/Leg22-KOMA.png",
    post: "Expedition3/Legs/leg-22.html",
    slug: "leg-22",
    lcDates: "July 30 – August 7, 1804",
    nm: 72,
    duration: "0:29"
  },
  {
    lat: 42.4013056,
    lng: -96.3844167,
    label: "Leg 23: Hallowed Ground",
    location: "KTQE → KSUX · Tekamah, NE to Sioux City, IA",
    date: "June 2, 2026",
    thumb: "Expedition3/Legs/Leg23-LittleSioux.png",
    post: "Expedition3/Legs/leg-23.html",
    slug: "leg-23",
    lcDates: "August 8–20, 1804",
    nm: 94.8,
    duration: "0:35"
  }
];
...
const EXP3_STATS = {
  ...
  updatedDate:  "June 2, 2026 4:12 PM MT"
};
...
const LEG_NOTES = {
  ...
  "leg-19": {
    facts: "Leg 19: KMKC → 64MO, 60 NM (1343.1-1282.8=60.3), May 26 2026, 0:39. 64MO = Booze Island Airport, SW of St. Joseph MO; snap [39.6731,-95.02425], cum 1343.1, 0.69 NM off-route. L&C dates June 29–July 4 1804; deferredDateCall resolved to June 29–July 4 (campBehind July 4 at 7.2 NM; campAhead July 5 at 2.4 NM; narrative ends at July 4 Independence Day). June 29: court martial Collins 100 lashes (drunk sentinel over whiskey barrel) and Hall 50 (drew whiskey); departed Kaw Point evening; keelboat stern 6 inches from sawyer. June 30: 96°F at 3 p.m.; noon rest 3 hrs; men 'becom verry feeble'; broken mast (overhanging tree, second; first was June 4 near Jefferson City); 9 deer, tracks 'as plenty as Hogs about a farm.' July 1: mile-long driftwood sandbar off Leavenworth; boils ongoing. July 2: flood of drift (island caved); bad sandbar (20 oars barely held); temporary mast rigged 4 hrs (turned 'butifull red Colour'); camped opposite first old Kansa village / Fort de Cavagnial (French, 1744–1764, near present Weston MO). July 3: stray white horse at old French trading house; 3 deer; gentle day. July 4: swivel gun sunrise/noon/sunset; extra gill whiskey; Independence Creek named (15 yds wide, near present Atchison KS; Clark's Field Notes vs Codex A differ on '4th of July Creek' vs 'Independence Creek'; present-day name preserves it); Joseph Field snake bite, Lewis treated with Peruvian bark; 'Jo. Fields Snake Prairie'; Gosling Lake (oxbow, geese/swans/fish); second old Kansa village (Doniphan site, Oneota, earliest documented); Clark: 'Leek Green Grass' = big bluestem (Andropogon gerardi); Ordway: 'one of the most beautiful places I ever Saw in my life.' Historical image: Michael Haynes 'Near Miss'; local asset Expedition3/Legs/Leg19-NearMiss.png; credit 'Michael Haynes — www.mhaynesart.com.' Photos: Leg19-CawPoint.png (not primary), Leg19-LewisAndClarkLake.png, Leg19-IndependenceCreek.png (primary), Leg19-NearMiss.png (historical). Video: YouTube -ywGm5fgkAQ.",
    covered: "Leg 19: 60 NM, 0:39, KMKC to 64MO (Booze Island Airport, SW of St. Joseph MO). Pilot overflew Little Platte River (right), Leavenworth and Fort Leavenworth (left, Kansas), Lewis and Clark Lake with Lewis and Clark Village and State Park on its shores. Crosswind approach at quite an angle; smooth touchdown, no ground-loop; raced a car on the runway and lost. Primary photo: Leg19-IndependenceCreek.png (Independence Creek ahead, Atchison KS on left). Video: landing at Booze Island (YouTube -ywGm5fgkAQ). Historical section ('The First Fourth of July West of the Mississippi'): June 29 Collins/Hall whiskey court martial (100 and 50 lashes) and sawyer near-miss on departure; June 30 96° heat, noon rest, second broken mast, nine deer ('as plenty as Hogs'); July 1–2 mile-long driftwood sandbar, flood of drift, 20-oar sandbar, temporary mast rigged 4 hours ('butifull red Colour'); July 4 first Independence Day west of the Mississippi — swivel gun sunrise/noon/sunset, Independence Creek named near Atchison KS, extra gill whiskey, Joseph Field snake bite (Peruvian bark), Clark's rhapsodic prairie description ('Leek Green Grass'), Ordway's agreement. Historical image: Haynes 'Near Miss' placed after driftwood paragraph."
  },
  "leg-20": {
    facts: "Jul 5: keelboat spun completely around three times (twice on quicksand, once on a drift raft); Seaman drove beavers from a lodge; passed second old Kansa village site. Jul 6: extreme heat, Clark blamed the river water ('wet a Shirt in a Few minits'); past the future site of St. Joseph; treeless 'bald hills' and prairie 'appearance of farms.' Jul 7: Pvt. Robert Frazer 'struck with the sun,' nearly the first death; Lewis bled him + gave saltpeter (Rush-era medicine). Jul 8: five men sick with violent headaches, others with boils; Lewis's mess-cook order. Jul 9-10: fire on shore taken for a Sioux war party, bow-piece cannon fired and party stood to arms — a false alarm (their own lost men, asleep). Jul 11: Floyd 'the men is all sick.' Jul 12: Pvt. Alexander Willard court-martialed for sleeping on guard — a capital offense under the Articles of War; 100 lashes in four installments of 25; Clark climbed Nemaha grave-mounds ('one of the most pleasing prospects I ever beheld'), carved his name by a petroglyph. Jul 13: Lewis gathered white sage on a fast 20-mi south-wind run. CONTEXT (verified via Founders Online): July 12, 1804, Jefferson received the Osage delegation (head chief White Hair, escorted by Pierre Chouteau) in Washington; quote is verbatim from his 12 Jul 1804 address. Foreshadowing (verified): 1808 Treaty of Fort Clark, negotiated under Indian agent William Clark, ceded most of present-day Missouri + northern Arkansas; later cessions; removal to Kansas then Oklahoma. Historical image: Michael Haynes 'Cat-O-Nine-Tails' (permission-cleared) placed after the Willard paragraph.",
    covered: "A short, calm hop past St. Joseph from Booze Island (64MO) to Lonesome Sky (MO24) — the narrower Missouri, farmland imagined as wild prairie, a drone-cam landing. Historical section covers the Corps' hardest week of sickness (Frazer's sunstroke, boils, Floyd's 'all sick'), Seaman driving beavers from a lodge, Willard's court-martial for sleeping on guard and why that was a capital offense, and — the same day — Jefferson's reception of the Osage in Washington, with a light note on how the promised 'everlasting' peace gave way to land cessions and removal. Image: Haynes 'Cat-O-Nine-Tails.'"
  },
  "leg-21": {
    facts: "July 14–27, 1804. July 14 NE storm that nearly wrecked the keelboat on a sand island (all hands overboard with anchor/cable; river 'smooth as glass' after ~40 min); same storm in which Clark's July 13 notes blew overboard; first wild elk chased, Seaman (Lewis's Newfoundland) joining. Painful boils/'tumors' troubled the men; Clark lanced an abscess as camp surgeon yet judged the party healthier than comparable groups. Osage country now behind them. July 21: reached the mouth of the Great Platte, a symbolic 'equator'; captains took a pirogue ~1 mi up; Lewis's hydrology (sand 'boiled up,' sandbars forming/dissolving in hours, Missouri shoved to its far bank; Platte adds sand not color; not navigable, crossed in skin bull boats). July 22: Camp White Catfish built ~10 mi above the Platte near present Bellevue; lay-by for observations, rest, and first attempt at Plains diplomacy. Drouillard & Cruzatte sent with tobacco to the Oto/Pawnee villages, found them empty (people out hunting buffalo). Clark copied his river map to send to Jefferson; Lewis prepared reports, but no White Catfish dispatch was ever found/sent. Camp named for Goodrich's pale catfish (possibly the channel catfish, new to science). Mosquitoes 'the size of house flies.' July 27: departed, examined old Oto/Iowa village mounds, camped in cottonwoods on the right shore north of Council Bluffs — the present Eppley Airfield grounds.",
    covered: "An evening hop up the winding Missouri from Lonesome Sky (MO24) to Eppley Airfield, Omaha (KOMA) — reaching the mouth of the Platte (whose South Platte arm flows through Captain Dadders's home of Denver ~500 mi away), passing downtown Omaha and the College World Series stadium, and a crosswind landing at the biggest airport of the trip so far, on the very ground where the Corps camped July 27, 1804. Historical section: the July 14 storm that nearly wrecked the keelboat, the first wild elk, the men's 'tumors,' leaving Osage country, reaching the Great Platte and Lewis's hydrology, Camp White Catfish and the failed Oto council, map-making and dispatches to Jefferson, and the house-fly mosquitoes. Image: George Catlin, 'Platte River' (c. 1832, public domain)."
  },
  "leg-22": {
    facts: "KOMA→KTQE 72.0 NM (cum 1508.9→1580.9), 0:29 actual vs 0:51 est at 85 kt; gap because route follows the modern, straighter channel while estimates use the 1804 polyline. KTQE snap 0.70 NM off-route. L&C boundary July 30–Aug 7, 1804 (deferred date call resolved to the Aug 7 Tekamah-ESE camp, 2.8 NM ahead). River-course change near Fort Atkinson verified: Missouri ran below Council Bluff in 1804, channel now ~3 mi east (HMDB marker, NPS); shift by natural eastward meander 1820–1937 then locked by Army Corps channelization beginning 1937 (Boyer Chute / Wikipedia, Lincoln Journal Star). Trade-threat in the council speech verified via James Ronda, Lewis and Clark Among the Indians (UNL): obey and traders come + post at the Platte; defy the 'bad birds' and trade is cut off with suffering. Native reception (NPS First Council): leaders were experienced diplomats, 'made some very sensible speeches,' took it in stride. Air gun astonished them (08-03 day-file). Council image: public-domain Patrick Gass-journal engraving via NPS / Library of Congress.",
    covered: "A short 72 NM hop from Eppley Field, Omaha (KOMA) up the modern Missouri to Tekamah Municipal (KTQE), with a detour to overfly the First Council site near Fort Atkinson and the Fort Calhoun quarry, and another bouncy landing. Historical section: the five-day wait at Council Bluff (Clark's 'finest ground,' the badger as first preserved specimen, Clark's 34th birthday); the Aug 2 arrival of the Otoe and Missouria; the Aug 3 First Council — the first formal U.S. council with a western nation — its medals and commissions, the trade-or-suffer threat folded into the speech and its hindsight irony, the Native delegates' unimpressed-but-gracious reception, and the air gun as the one thing that truly astonished them; the snag-choked push north, Reed's desertion and the Aug 7 detachment sent to retrieve him, Floyd's first note of illness; and how the river itself has since moved three miles east of the bluff."
  },
  "leg-23": {
    facts: "KTQE→KSUX 94.8 NM (cum 1580.9→1675.7), 0:35 actual vs 1:07 est at 85 kt; gap because the route follows the modern, straighter, channelized Missouri while estimates use the longer 1804 polyline (same effect noted on Legs 21–22). KSUX AirNav pin 42-24-04.7N 096-23-03.9W = 42.4013056,-96.3844167; snap [42.41995,-96.40681], 1.5 NM off-route, snapIndex 926. KSUX = Sioux Gateway / Brig. Gen. Bud Day Field, just W of Sergeant Bluff, IA; standing NOTAM caution for migratory-waterfowl birdstrike spring/fall (AirNav). L&C boundary Aug 8–20, 1804 (deferred date call resolved to the camp AHEAD, Aug 20 Floyd’s River mouth / Sioux City, 4.0 NM fwd vs Fish Camp 13.9 NM back; chosen because the destination IS Floyd’s Bluff). Verified from per-day research files (UNL journals + lewis-clark.org): Aug 8 pelican spectacle near Little Sioux R., Lewis’s American white pelican (Pelecanus erythrorhynchos) description, pouch held ~5 gal; white pelicans remain common spring/fall migrants in the Missouri Valley (general ornithology + KSUX waterfowl NOTAM). Aug 9 ~15-mi meander cutoff (Blue Lake/Onawa oxbow); Aug 12 Snyder Bend 18.75 mi by water vs ~half mi across the neck. Aug 10 Blackbird Hill in view (~300 ft, ~4 mi W); earliest surviving herbarium specimen (field horsetail). Aug 11 captains + 10 men placed an 8-ft pole and a white flag bound red/blue/white on Blackbird’s (Washinga Sahba) grave; Blackbird d. c.1800 of smallpox, arsenic-poisoning sorcery legend, buried seated on his horse. Aug 13 Ordway’s party found Tonwantonga (Omaha Big Village) empty and burned — ~400 dead of smallpox winter 1799–1800 (≈half the nation) + people away on buffalo hunt. Aug 15 fish drag (~300+ fish), smoke to N investigated by Pierre Dorion Sr., proved an accidental prairie fire from a Sioux campfire. Aug 16 Lewis’s drag ~709–800 fish. Aug 17 captains set prairie afire as a signal; Labiche reports deserters caught — La Liberté escaped again (never recovered), Reed brought back. Aug 18 Lewis’s 30th birthday; Reed ran the gauntlet 4x and was expelled (trial later struck from Clark’s journal; absent from 1814 History); Oto/Missouria chiefs (Little Thief, Big Horse) arrive — NOT the Omaha (page title “The Omahas arrive” is loose). Aug 19 Oto/Missouria council, medals/commissions, tense gift-begging, air gun + magnet; Floyd seized with bilious colic. Aug 20 Sgt. Charles Floyd dies (modern consensus: ruptured appendix/peritonitis) — the expedition’s only death; buried with full honors on Floyd’s Bluff, branded cedar post, Floyd’s Bluff + Floyd’s River named. Historical image: public-domain Bodmer Blackbird Hill vignette (Library of Congress).",
    covered: "A long 94.8 NM run up the modern Missouri from Tekamah (KTQE) to Sioux Gateway at Sioux City (KSUX), again far shorter in the air than the 1804 estimate because the river has been straightened, past the Little Sioux confluence and a fruitless search for Blackbird Hill along the ridge (it no longer matches the 19th-century images), to a windy, slightly bouncy landing on Sioux Gateway’s into-wind runway beside Sergeant Bluff. Historical section (Aug 8–20, 1804): the river’s great meander cutoffs (Blue Lake, Snyder Bend) that explain the modern shortening; the August 8 white-pelican spectacle and the bird’s continued abundance here; Blackbird Hill and the flag the captains raised on the chief’s grave; the smallpox catastrophe that, with the summer buffalo hunt, left the Omaha Big Village empty and burned; the layover at Fish Camp — the great fish drags, Dorion’s chase after a smoke that proved an accidental prairie fire while looking for the Sioux, and the captains’ own signal fire; the resolution of the desertion thread (Reed’s capture and gauntlet, La Liberté’s escape); Lewis’s 30th birthday; the tense Oto/Missouria council (not the absent Omaha); and the death and burial of Sergeant Charles Floyd, the expedition’s only fatality, on the bluff that still bears his name."
  }
};
...
const AIRPORT_PLAN = {
  ...
  "KAFK": {
    snap: [40.61879, -95.78834],
    snapIndex: 746,
    offRouteNM: 3.65,
    campBehind: { date: "1804-07-16/17", place: "left shore, 5 mi south of Hamburg, IA", gapNM: 12.7 },
    campAhead:  { date: "1804-07-18", place: "right shore, 2½ mi S of Payne, IA, in KA?", gapNM: 0.9 },
    deferredDateCall: true
  },
  "KOMA": {
